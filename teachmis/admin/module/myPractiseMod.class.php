<?php
//用户管理
class myPractiseMod extends commonMod {
	...
	public function index() {
        ...
        //获取行数
        $num=model('myPractise')->myPractiseCount($_GET['search']);
        //获取信息列表
        $list=model('myPractise')->myPractiseList($_GET['search'],$limit);

...
/**
  ...
  public function nextPage($style='nextPage',$type=1)
 {
	...
	{
		if($type){
			return $this->_getLink($this->_getUrl($this->nowIndex),$this->nextPage,$style);
		}else{
			return $this->_getUrl($this->nowIndex);
		}
	}
    return '';
}
 ...
 */
	public function show($url="",$total=0,$perPage=10,$pageBarNum=5,$mode=1)
	{
